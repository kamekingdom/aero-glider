...
def find_closest_words(input_string):
    ...
    filtered_words = [word for word in english_words.keys() if len(word) in range(len(input_string) - 2, len(input_string) + 3)]
...
english_words = {word: None for word in words.words()}
